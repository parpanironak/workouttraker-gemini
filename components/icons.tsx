...
export const DumbbellIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    <path d="M14.4 14.4 9.6 9.6"/><path d="M18.657 11.314a2 2 0 1 1-2.828-2.828l1.414-1.414a2 2 0 1 1 2.828 2.828z"/><path d="M12.728 20.07a2 2 0 1 1-2.828-2.828l1.414-1.414a2 2 0 1 1 2.828 2.828z"/><path d="m21.5 21.5-1.4-1.4"/><path d="m4 4 6 6"/><path d="m3 21 6-6"/><path d="M21 3l-6 6"/><path d="M12.728 5.686a2 2 0 1 1-2.828-2.828l1.414-1.414a2 2 0 1 1 2.828 2.828z"/>
  </svg>
);
